...
//wersja bez sprytnych wskażników
...
int main() {
    ...
    Order * blackWithMilk = new Order;
    blackWithMilk->addMilk = "yes";
    blackWithMilk->price += 1.99;

    Order * white = new Order;
    white->tea = "white";
    white->price = 13.99;

    Order * greenWithHoney = new Order;
    ...
    delete blackWithMilk;
    delete white;
    delete greenWithHoney;
    delete customer7;
    delete customer6;
    delete customer5;
    delete customer4;
